...
/**
 * Basic sanity tests for WarehouseOperations service
...
public class BasicSanityTest {
    ...
    public void applicationPropertiesTest() {
        ...
        String appName = System.getProperty("spring.application.name", "warehouse-operations");
    ...
    public void serviceInitializationTest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String serviceName = "warehouse-operations";
