...
## Overview
integration-tests is a microservice component of the Warehousing Domain that contains integration test suites for validating cross-service interactions.
