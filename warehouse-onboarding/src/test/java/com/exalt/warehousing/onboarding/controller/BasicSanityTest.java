...
/**
 * Basic sanity tests for WarehouseOnboarding service
...
public class BasicSanityTest {
    ...
    public void applicationPropertiesTest() {
        ...
        String appName = System.getProperty("spring.application.name", "warehouse-onboarding");
    ...
    public void serviceInitializationTest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String serviceName = "warehouse-onboarding";
