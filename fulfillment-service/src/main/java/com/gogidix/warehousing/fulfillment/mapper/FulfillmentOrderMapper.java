...
import com.gogidix.warehousing.fulfillment.enums.Priority;
...
public interface FulfillmentOrderMapper {
    ...
    default com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus mapEntityStatusToDto(
            com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus entityStatus) {
    ...
    default com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus mapDtoStatusToEntity(
            com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus dtoStatus) {
        if (dtoStatus == null) {
            return null;
        }
