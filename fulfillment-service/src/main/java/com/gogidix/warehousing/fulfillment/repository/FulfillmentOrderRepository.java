...
public interface FulfillmentOrderRepository extends JpaRepository<FulfillmentOrder, String> {
    ...
    @Query("SELECT fo FROM FulfillmentOrder fo WHERE fo.status NOT IN " +
           "(com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.COMPLETED, " +
           "com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.DELIVERED, " +
           "com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.CANCELLED)")
    ...
    @Query("SELECT fo FROM FulfillmentOrder fo WHERE fo.status = " +
           "com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.ALLOCATED " +
     ...
     */
    @Query("SELECT fo FROM FulfillmentOrder fo WHERE fo.status = " +
           "com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.PICKING_COMPLETE " +
     ...
     */
    @Query("SELECT fo FROM FulfillmentOrder fo WHERE fo.status = " +
           "com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.READY_TO_SHIP " +
