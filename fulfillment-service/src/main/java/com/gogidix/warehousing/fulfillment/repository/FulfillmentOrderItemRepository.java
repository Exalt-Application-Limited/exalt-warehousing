package com.gogidix.warehousing.fulfillment.repository;
...
public interface FulfillmentOrderItemRepository extends JpaRepository<FulfillmentOrderItem, UUID> {
    ...
    @Query("SELECT i FROM FulfillmentOrderItem i WHERE i.fulfillmentOrder.id = :fulfillmentOrderId " +
           "AND (i.status = com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PENDING " +
           "OR i.status = com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.ALLOCATED)")
     ...
     */
    @Query("SELECT i FROM FulfillmentOrderItem i WHERE i.fulfillmentOrder.id = :fulfillmentOrderId " +
           "AND i.status = com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PICKED")
    ...
    @Query("SELECT COUNT(i) = 0 FROM FulfillmentOrderItem i WHERE i.fulfillmentOrder.id = :fulfillmentOrderId " +
           "AND i.status NOT IN (com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PICKED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PACKED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.SHIPPED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.FULFILLED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.CANCELLED)")
     ...
     */
    @Query("SELECT COUNT(i) = 0 FROM FulfillmentOrderItem i WHERE i.fulfillmentOrder.id = :fulfillmentOrderId " +
           "AND i.status NOT IN (com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PACKED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.SHIPPED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.FULFILLED, " +
           "com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.CANCELLED)")
