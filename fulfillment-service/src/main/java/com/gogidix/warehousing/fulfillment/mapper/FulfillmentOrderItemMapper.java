package com.gogidix.warehousing.fulfillment.mapper;
...
public interface FulfillmentOrderItemMapper {
    ...
    default com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus mapEntityItemStatusToDto(
            com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus entityStatus) {
        ...
        switch (entityStatus) {
            ...
            case PICKING:
                return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PICKED;
            case PACKING:
                return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PACKED;
            case DAMAGED:
                return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.CANCELLED;
            case RETURNED:
                return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.CANCELLED;
            default:
                // Try to match by name
                try {
                    return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.valueOf(entityStatus.name());
                } catch (IllegalArgumentException e) {
                    // If no exact match, return a default
                    return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PENDING;
                }
        }
    }
    ...
    default com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus mapDtoItemStatusToEntity(
            com.gogidix.warehousing.fulfillment.enums.ItemStatus dtoStatus) {
        if (dtoStatus == null) {
            return null;
        }
        ...
        switch (dtoStatus) {
            case SHIPPED:
                return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.SHIPPED;
            case SUBSTITUTED:
                return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.CANCELLED;
            default:
                // Try to match by name
                try {
                    return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.valueOf(dtoStatus.name());
                } catch (IllegalArgumentException e) {
                    // If no exact match, return a default
                    return com.gogidix.warehousing.fulfillment.enums.ItemFulfillmentStatus.PENDING;
                }
