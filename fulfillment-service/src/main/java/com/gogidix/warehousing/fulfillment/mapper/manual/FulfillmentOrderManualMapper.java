package com.gogidix.warehousing.fulfillment.mapper.manual;
...
import com.gogidix.warehousing.fulfillment.entity.FulfillmentOrder;
import com.gogidix.warehousing.fulfillment.entity.FulfillmentOrderItem;
...
public class FulfillmentOrderManualMapper {
    ...
    public FulfillmentOrderDTO toDTO(FulfillmentOrder fulfillmentOrder) {
        ...
        dto.setCompleted(com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.DELIVERED.equals(fulfillmentOrder.getStatus()) ||
                        com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.COMPLETED.equals(fulfillmentOrder.getStatus()));
        dto.setActive(!com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.CANCELLED.equals(fulfillmentOrder.getStatus()) &&
                     !com.gogidix.warehousing.fulfillment.enums.FulfillmentStatus.DELIVERED.equals(fulfillmentOrder.getStatus()));
    ...
    public FulfillmentOrder toEntity(FulfillmentOrderDTO dto) {
        ...
        if (dto.getShippingAddressLine1() != null || dto.getShippingCity() != null) {
            com.gogidix.warehousing.fulfillment.entity.Address address = new com.gogidix.warehousing.fulfillment.entity.Address();
     ...
     */
    private com.gogidix.warehousing.fulfillment.enums.ShippingMethod parseShippingMethod(String method) {
        if (method == null || method.trim().isEmpty()) {
            return com.gogidix.warehousing.fulfillment.enums.ShippingMethod.STANDARD;
        }
        try {
            return com.gogidix.warehousing.fulfillment.enums.ShippingMethod.valueOf(method.toUpperCase());
        } catch (IllegalArgumentException e) {
            return com.gogidix.warehousing.fulfillment.enums.ShippingMethod.STANDARD;
        }
    }
     ...
     */
    private com.gogidix.warehousing.fulfillment.enums.Priority mapPriority(Integer priority) {
        if (priority == null) {
            return com.gogidix.warehousing.fulfillment.enums.Priority.STANDARD;
        }
        com.gogidix.warehousing.fulfillment.enums.Priority[] values = com.gogidix.warehousing.fulfillment.enums.Priority.values();
