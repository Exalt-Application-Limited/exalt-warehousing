...
## Overview
self-storage-service is a microservice component of the Warehousing Domain that manages self-storage facilities, unit allocations, and customer storage operations.
