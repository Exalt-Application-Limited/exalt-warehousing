...
/**
 * Basic sanity tests for WarehouseSubscription service
...
public class BasicSanityTest {
    ...
    public void applicationPropertiesTest() {
        ...
        String appName = System.getProperty("spring.application.name", "warehouse-subscription");
    ...
    public void serviceInitializationTest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String serviceName = "warehouse-subscription";
