...
public interface SubscriptionService {
     ...
     */
    WarehouseSubscription createSubscription(com.exalt.warehousing.subscription.dto.SubscriptionCreateRequest request);
    
    /**
     * Get subscription details as DTO
     */
    com.exalt.warehousing.subscription.dto.SubscriptionDetailDTO getSubscriptionDetails(String subscriptionId);
     ...
     */
    Page<WarehouseSubscription> searchSubscriptions(com.exalt.warehousing.subscription.dto.SubscriptionSearchRequest searchRequest, Pageable pageable);
    
    /**
     * Update subscription using DTO
     */
    WarehouseSubscription updateSubscription(String subscriptionId, com.exalt.warehousing.subscription.dto.SubscriptionUpdateRequest request);
     ...
     */
    com.exalt.warehousing.subscription.dto.PlanChangeResult upgradePlan(String subscriptionId, com.exalt.warehousing.subscription.dto.PlanUpgradeRequest request);
    
    /**
     * Downgrade plan using DTO
     */
    com.exalt.warehousing.subscription.dto.PlanChangeResult downgradePlan(String subscriptionId, com.exalt.warehousing.subscription.dto.PlanDowngradeRequest request);
    
    /**
     * Get available plans as DTOs
     */
    List<com.exalt.warehousing.subscription.dto.SubscriptionPlanDTO> getAvailablePlans();
    
    /**
     * Get plan recommendations
     */
    List<com.exalt.warehousing.subscription.dto.PlanRecommendation> getPlanRecommendations(String subscriptionId);
    
    /**
     * Record usage using DTO with String ID
     */
    UsageRecord recordUsageWithStringId(String subscriptionId, com.exalt.warehousing.subscription.dto.UsageRecordRequest request);
     ...
     */
    com.exalt.warehousing.subscription.dto.UsageSummary getCurrentUsageSummary(String subscriptionId);
    
    /**
     * Process billing with String ID
     */
    com.exalt.warehousing.subscription.dto.BillingResult processBillingWithStringId(String subscriptionId);
    
    /**
     * Get invoices with String ID
     */
    Page<com.exalt.warehousing.subscription.dto.InvoiceDTO> getInvoices(String subscriptionId, java.time.LocalDate startDate, java.time.LocalDate endDate, Pageable pageable);
    
    /**
     * Process payment using DTO
     */
    com.exalt.warehousing.subscription.dto.PaymentResult processPayment(String subscriptionId, com.exalt.warehousing.subscription.dto.PaymentRequest request);
    
    /**
     * Get payment history with String ID
     */
    Page<com.exalt.warehousing.subscription.dto.PaymentRecord> getPaymentHistory(String subscriptionId, Pageable pageable);
    
    /**
     * Get revenue analytics
     */
    com.exalt.warehousing.subscription.dto.RevenueAnalytics getRevenueAnalytics(java.time.LocalDate startDate, java.time.LocalDate endDate, String groupBy);
    
    /**
     * Get churn analytics
     */
    com.exalt.warehousing.subscription.dto.ChurnAnalytics getChurnAnalytics(java.time.LocalDate startDate, java.time.LocalDate endDate);
    
    /**
     * Get subscription analytics with String ID
     */
    com.exalt.warehousing.subscription.dto.SubscriptionAnalytics getSubscriptionAnalytics(String subscriptionId, int days);
    
    /**
     * Get subscription metrics overview
     */
    com.exalt.warehousing.subscription.dto.SubscriptionMetricsOverview getSubscriptionMetricsOverview();
     ...
     */
    com.exalt.warehousing.subscription.dto.BulkBillingResult bulkProcessBilling(List<String> subscriptionIds);
    
    /**
     * Bulk send notifications
     */
    com.exalt.warehousing.subscription.dto.BulkNotificationResult bulkSendNotifications(com.exalt.warehousing.subscription.dto.BulkNotificationRequest request);
    
    /**
     * Get service health
     */
    com.exalt.warehousing.subscription.dto.ServiceHealthStatus getServiceHealth();
    
    /**
     * Get subscription status
     */
    com.exalt.warehousing.subscription.dto.SubscriptionStatusDTO getSubscriptionStatus(String subscriptionId);
}
