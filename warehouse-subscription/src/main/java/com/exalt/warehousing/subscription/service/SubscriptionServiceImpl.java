...
import com.exalt.warehousing.subscription.repository.BillingRecordRepository;
import com.exalt.warehousing.subscription.repository.SubscriptionRepository;
import com.exalt.warehousing.subscription.repository.UsageRecordRepository;
import com.exalt.warehousing.subscription.dto.UsageSummary;
...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    @Override
    public WarehouseSubscription createSubscription(com.exalt.warehousing.subscription.dto.SubscriptionCreateRequest request) {
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.SubscriptionDetailDTO getSubscriptionDetails(String subscriptionId) {
        try {
            // Convert String to UUID with proper error handling - FIXED
            
            WarehouseSubscription subscription = getSubscription(subscriptionId);
            // Convert to DTO (placeholder)
            return new com.exalt.warehousing.subscription.dto.SubscriptionDetailDTO();
    ...
    @Override
    public Page<WarehouseSubscription> searchSubscriptions(com.exalt.warehousing.subscription.dto.SubscriptionSearchRequest searchRequest, Pageable pageable) {
    ...
    @Override
    public WarehouseSubscription updateSubscription(String subscriptionId, com.exalt.warehousing.subscription.dto.SubscriptionUpdateRequest request) {
        try {
            // Convert String to UUID with proper error handling - FIXED
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.PlanChangeResult upgradePlan(String subscriptionId, com.exalt.warehousing.subscription.dto.PlanUpgradeRequest request) {
        try {
            // Convert String to UUID with proper error handling - FIXED
            ...
            return new com.exalt.warehousing.subscription.dto.PlanChangeResult();
        } catch (IllegalArgumentException e) {
            throw new ValidationException("Invalid subscription ID format: " + subscriptionId);
        }
    }
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.PlanChangeResult downgradePlan(String subscriptionId, com.exalt.warehousing.subscription.dto.PlanDowngradeRequest request) {
        // Stub implementation
        return new com.exalt.warehousing.subscription.dto.PlanChangeResult();
    }

    @Override
    public List<com.exalt.warehousing.subscription.dto.SubscriptionPlanDTO> getAvailablePlans() {
        return new ArrayList<>();
    }

    @Override
    public List<com.exalt.warehousing.subscription.dto.PlanRecommendation> getPlanRecommendations(String subscriptionId) {
        try {
            // Convert String to UUID with proper error handling - FIXED
    ...
    @Override
    public UsageRecord recordUsageWithStringId(String subscriptionId, com.exalt.warehousing.subscription.dto.UsageRecordRequest request) {
        try {
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.BillingResult processBillingWithStringId(String subscriptionId) {
        try {
            // Convert String to UUID with proper error handling - FIXED
            
            BillingRecord result = processBilling(subscriptionId);
            return new com.exalt.warehousing.subscription.dto.BillingResult();
        } catch (IllegalArgumentException e) {
            throw new ValidationException("Invalid subscription ID format: " + subscriptionId);
        }
    }
    ...
    @Override
    public Page<com.exalt.warehousing.subscription.dto.InvoiceDTO> getInvoices(String subscriptionId, java.time.LocalDate startDate, java.time.LocalDate endDate, Pageable pageable) {
        try {
            // Convert String to UUID with proper error handling - FIXED
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.PaymentResult processPayment(String subscriptionId, com.exalt.warehousing.subscription.dto.PaymentRequest request) {
        try {
            // Convert String to UUID with proper error handling - FIXED
            
            WarehouseSubscription subscription = getSubscription(subscriptionId);
            // Stub implementation
            return new com.exalt.warehousing.subscription.dto.PaymentResult();
        } catch (IllegalArgumentException e) {
            throw new ValidationException("Invalid subscription ID format: " + subscriptionId);
        }
    }
    ...
    @Override
    public Page<com.exalt.warehousing.subscription.dto.PaymentRecord> getPaymentHistory(String subscriptionId, Pageable pageable) {
        try {
            // Convert String to UUID with proper error handling - FIXED
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.RevenueAnalytics getRevenueAnalytics(java.time.LocalDate startDate, java.time.LocalDate endDate, String groupBy) {
        return new com.exalt.warehousing.subscription.dto.RevenueAnalytics();
    }

    @Override
    public com.exalt.warehousing.subscription.dto.ChurnAnalytics getChurnAnalytics(java.time.LocalDate startDate, java.time.LocalDate endDate) {
        return new com.exalt.warehousing.subscription.dto.ChurnAnalytics();
    }

    @Override
    public com.exalt.warehousing.subscription.dto.SubscriptionAnalytics getSubscriptionAnalytics(String subscriptionId, int days) {
        try {
            // Convert String to UUID with proper error handling - FIXED
            
            WarehouseSubscription subscription = getSubscription(subscriptionId);
            return new com.exalt.warehousing.subscription.dto.SubscriptionAnalytics();
        } catch (IllegalArgumentException e) {
            throw new ValidationException("Invalid subscription ID format: " + subscriptionId);
        }
    }
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.SubscriptionMetricsOverview getSubscriptionMetricsOverview() {
        return new com.exalt.warehousing.subscription.dto.SubscriptionMetricsOverview();
    }
    ...
    @Override
    public com.exalt.warehousing.subscription.dto.BulkBillingResult bulkProcessBilling(List<String> subscriptionIds) {
        ...
        return new com.exalt.warehousing.subscription.dto.BulkBillingResult();
    }

    @Override
    public com.exalt.warehousing.subscription.dto.BulkNotificationResult bulkSendNotifications(com.exalt.warehousing.subscription.dto.BulkNotificationRequest request) {
        return new com.exalt.warehousing.subscription.dto.BulkNotificationResult();
    }

    @Override
    public com.exalt.warehousing.subscription.dto.ServiceHealthStatus getServiceHealth() {
        return new com.exalt.warehousing.subscription.dto.ServiceHealthStatus();
    }

    @Override
    public com.exalt.warehousing.subscription.dto.SubscriptionStatusDTO getSubscriptionStatus(String subscriptionId) {
        try {
            // Convert String to UUID with proper error handling - FIXED
            
            WarehouseSubscription subscription = getSubscription(subscriptionId);
            return new com.exalt.warehousing.subscription.dto.SubscriptionStatusDTO();
        } catch (IllegalArgumentException e) {
            throw new ValidationException("Invalid subscription ID format: " + subscriptionId);
        }
    }
